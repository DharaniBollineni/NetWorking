...
public class DeleteTCPMultiClientReg {
...
//	    
        ...
        // loop
        runClient(message,turns, remoteServerPort, i, ip);
...
//        
	...
	public static void runClient(String message,int turns, int remoteServerPort, int i,InetAddress ip) throws IOException
	{
//		 while (true) 
//	        { 
	        	Socket localSocket = new Socket(ip, remoteServerPort); //connect to server //send data
