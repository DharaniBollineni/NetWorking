...
public class JokeServerWithFile {
	...
	public static void main(String[] args) throws IOException {
        ...
        { 
            ...
            System.out.println("number receievd = "+jokeNumber);
            ...
            if(jokeNumber%2!=0)
            {
            	...
            	System.out.println("Joke 1: " + strJoke);
            ...
            else
            {
            	...
            	strJoke=readJoke(2);
            	System.out.println("Joke 2: " + strJoke);
            	buf = strJoke.getBytes();   // convert the String input into the byte array.
            	DatagramPacket DpSend = new DatagramPacket(buf, buf.length, ip, 4321);   // convert to data packet  
            	ds.send(DpSend); // sends as packet so no need to convert to          
            }
...
//            } 
	...
	// file program to read required line
	public static String readJoke(int findLine)
	{
		String lineStr = "";//,dummyLineStr="";
		int i=1;
		 try {
			   File file = new File("JokeFile.txt");
			   Scanner scanner = new Scanner(file);			   
			   while (scanner.hasNext()) {
				if(i==findLine)   
					lineStr=scanner.nextLine();//scanner.next();
